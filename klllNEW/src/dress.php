...
<section class="new-product py-5">
    <div class="container" style="font-family: Macondo; color: #814603;">
        ...
        $query = mysqli_query($conn, "SELECT DISTINCT jenis FROM tb_produk WHERE katagori = 7");
        ...
        <div class="row g-4">
            <?php
            $produk = mysqli_query($conn, "SELECT * FROM tb_produk WHERE katagori = 7 ORDER BY id_produk DESC");
